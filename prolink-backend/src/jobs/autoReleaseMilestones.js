...
const AUTO_RELEASE_HOURS = parseInt(process.env.AUTO_RELEASE_HOURS || '72', 10);
    ...
    try {
      ...
      if (milestone.job.client?.email) {
        ...
        await emailService.sendNotificationEmail(
          ...
          `The milestone "${milestone.job.title}" has been auto-approved after ${AUTO_RELEASE_HOURS} hours of inactivity.`,
          `<div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
            <h2>Milestone Auto-Approved ⏰</h2>
            <p>The milestone for <strong>${milestone.job.title}</strong> has been automatically approved because no action was taken within ${AUTO_RELEASE_HOURS} hours of the provider's submission.</p>
